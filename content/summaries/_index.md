...
You can find the summaries via the menu in the left. We made a distinction between "[Open and Reproducible Science](/summaries/open-reproducible/)" summaries and "[Diversity, Equity, & Inclusion](/diversity-equity-inclusion/)" summaries to highlight that the topics of social injustices and DEI (diversity, equity and inclusion) in academia are often neglected in open and reproducible science literature. We have also prepared a [.pdf version of these summaries  (this is not updated, but please come back in a matter of days as it will be updated soon!)](OS_Literature_Summaries_by_FORRT.pdf) in case you want to keep a copy for yourself. If you are an educator, you may also be interested in our [FORRT Syllabus on Open and Reproducible Science](FORRT_O&R_101_Syllabus.pdf), which is based on [FORRT Clusters.](/clusters/)
