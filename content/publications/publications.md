...
We have conducted an open educational resource project [FORRT's Lesson Plans](/lesson-plans) in response to the varied and plural new terminology introduced by the *open scholarship* movement, which has transformed academia's lexicon, to facilitate education and effective communication between experts and newcomers. We have written a manuscript entitled *A Community-Sourced Glossary of Open Scholarship Terms* presenting the beta 0.1 version of our glossary of open scholarship terms to facilitate education and effective communication between experts and newcomers.
