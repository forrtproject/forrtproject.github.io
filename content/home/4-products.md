...
[[featurealt]]
  ...
  description = "The educational NEXUS is an e-learning platform for educators teachers to Find, Access, Interoperate, and Reuse (FAIR) teaching and mentoring resources & materials. The pedagogical content of all resources is maximized to facilitate adaptation and reuse. We welcome new contributions to help build diversity in the collated resources (check out [how to get involved](/about/get-involved)). FORRT strongly advocates for these resources being used, cited and recognized. We have produced the following resources [About Educational Nexus](/nexus), [Adopting Principled Teaching & Mentoring Practices](/adopting), [Citation Politics](/citation-politics), [Pedagogical Clusters of OS literature](/clusters), [Curated OS Resources](/resources), [Developing Countries & OS](/os-developing-world), [Equity in Open Science](/equityinos),  [Educator's Corner](/educators-corner), [Games Portal](/games), [Glossary of OS terminology](/glossary), [Literature Review on the impact of Open Scholarship on students](/impact),  [Initiatives Towards Social Justice in Academia](/dei), [Lesson Plans](/lesson-plans), [Mapping OS Communities](/mapping_os), [Neurodiversity resources](/neurodiversity/), [Pedagogies](/pedagogies), [Summaries of OS literature](/summaries), [OS Syllabus](https://forrt.org/syllabus), and a [Self-Assessment Tool](/self-assessment)[Teaching OS](/teaching_os), and the [Academic Wheel of Privilege (AWoP)](/awop) ."
